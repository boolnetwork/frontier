...
> [Subtrate node template release process](https://github.com/boolnetwork/polkadot-sdk/blob/master/bin/node-template/README.md) -
...
4.  There are actually two packages in the Node Template, `frontier-node-template` (the node),
    ...
    remote repository, such as:
        ...
        git = 'https://github.com/boolnetwork/polkadot-sdk.git'
